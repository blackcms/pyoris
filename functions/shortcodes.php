...
app()->booted(function () {
    ...
    if (is_addon_active("blog")) {
        ...
        shortcode()->setAdminConfig("recent-posts", function (
            $attributes,
            $content
        ) {
            return Theme::partial(
                "shortcodes.recent-posts-admin-config",
        ...
        shortcode()->setAdminConfig("featured-categories-posts", function (
            $attributes
        ) {
    ...
    if (is_addon_active("gallery")) {
        ...
        shortcode()->setAdminConfig("all-galleries", function (
            $attributes,
            $content
        ) {
            return Theme::partial(
                "shortcodes.all-galleries-admin-config",
                compact("attributes", "content")
            );
        });
    }
